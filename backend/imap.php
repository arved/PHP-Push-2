...
class BackendIMAP extends BackendDiff {
    ...
    public function Logon($username, $domain, $password) {
        $IMAPuser = $username . IMAP_USERNAMEEXTENSION;
        ZLog::Write(LOGLEVEL_DEBUG, sprintf("BackendIMAP->Logon(): Loginname: '$IMAPuser'"));
        $this->wasteID = false;
        $this->sentID = false;
